...
// Source: github.com/TechTrm/Authentication-Api-Services/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) GetListUsers(arg0 context.Context, arg1 db.GetListUsersParams) ([]db.GetListUsersRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetListUsers", arg0, arg1)
	ret0, _ := ret[0].([]db.GetListUsersRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetListUsers indicates an expected call of GetListUsers.
func (mr *MockStoreMockRecorder) GetListUsers(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetListUsers", reflect.TypeOf((*MockStore)(nil).GetListUsers), arg0, arg1)
}
...
// GetUserByNameOrEmail mocks base method.
func (m *MockStore) GetUserByNameOrEmail(arg0 context.Context, arg1 db.GetUserByNameOrEmailParams) (db.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserByNameOrEmail", arg0, arg1)
	ret0, _ := ret[0].(db.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUserByNameOrEmail indicates an expected call of GetUserByNameOrEmail.
func (mr *MockStoreMockRecorder) GetUserByNameOrEmail(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByNameOrEmail", reflect.TypeOf((*MockStore)(nil).GetUserByNameOrEmail), arg0, arg1)
}
